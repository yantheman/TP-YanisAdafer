	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		...
		<?php if(AuthComponent::user('id')){?>
			<ul class="nav navbar-nav side-nav">
                ...
                <li class="dropdown <?php echo $this->params->params['controller'] == 'distributors' ? 'active' : ''?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-distributors"></i> Distributors <b
							class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo $this->params->webroot?>distributors"><i class="fa fa-list"></i> List</a></li>
						<li><a href="<?php echo $this->params->webroot?>distributors/add"><i class="fa fa-plus"></i> Register new distributor</a></li>
					</ul>
				</li>
                <li class="dropdown <?php echo $this->params->params['controller'] == 'members' ? 'active' : ''?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-members"></i> Members <b
							class="caret"></b></a>
					<ul class="dropdown-menu">
                ...
                <li class="dropdown <?php echo $this->params->params['controller'] == 'products' ? 'active' : ''?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-products"></i> Products <b
							class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo $this->params->webroot?>products"><i class="fa fa-list"></i> List</a></li>
						<li><a href="<?php echo $this->params->webroot?>products/add"><i class="fa fa-plus"></i> Register new product</a></li>
					</ul>
				</li>
